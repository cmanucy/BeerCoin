# Support for Output Descriptors in BEERCoin Core

Since BEERCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bisac1...` for mainnet or `tbisac1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on BEERCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing BEERCoin Core wallets, a convenience function `combo` is
