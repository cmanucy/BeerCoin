...
"""Verify that starting beercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beercoin with -h for help text")
        ...
        self.log.info("Start beercoin with -version for version information")
        ...
        self.log.info("Start beercoind with -fakearg to make sure it does not start")
