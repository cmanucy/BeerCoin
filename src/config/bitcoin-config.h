...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BEERCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BEERCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/beercoin-project/beercoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BEERCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BEERCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "beercoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://beercoin.org/"
