...
const char * const BITCOIN_CONF_FILENAME = "beercoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BEERCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BEERCoin";
#else
    // Unix
    return pathRet / ".beercoin";
#endif
#endif
}
