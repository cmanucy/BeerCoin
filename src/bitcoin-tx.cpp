...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " beercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  beercoin-tx [options] <hex-tx> [commands]  Update hex-encoded beercoin transaction\n" +
            "or:     beercoin-tx [options] -create [commands]   Create hex-encoded beercoin transaction\n" +
            "\n";
