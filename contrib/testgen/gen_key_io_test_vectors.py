...
bech32_templates = [
  ...
  ('bisac',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bisac',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bisac',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbisac',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbisac',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbisac',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbisac',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbisac',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbisac', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbisac',  17, 32, False, False, False),
  ('rbisac',  3,  1, False, False, False),
  ('bisac',   15, 41, False, False, False),
  ('tbisac',  0, 16, False, False, False),
  ('rbisac',  0, 32, True,  False, False),
  ('bisac',   0, 16, True,  False, False),
  ('tbisac',  0, 32, False, True,  False),
  ('rbisac',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['bisac', 'tbisac', 'rbisac']:
